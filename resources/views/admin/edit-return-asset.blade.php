    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Return Asset Form</h3>
...
{{--                       <p>This is the most basic and default form having form sections.
                    ...
                    <form class="form">
                      ...
                      <div class="form-group">
                          <label for="companyName">Return Asset ID</label>
                          <input type="text" id="return_asset_id" class="form-control" placeholder="Username"
                          name="return_asset_id" value="" readonly>
                        </div>
                         <div class="form-group">
