<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class=" nav-item"><a href="index.html"><i class="la la-sign-in"></i><span class="menu-title" data-i18n="nav.dash.main">Request</span></a>
        <ul class="menu-content">
     ...
     <li class=" nav-item"><a href="index.html"><i class="la la-retweet"></i><span class="menu-title" data-i18n="nav.dash.main">Return</span></a>
        <ul class="menu-content">
      ...
      <li class=" nav-item"><a href="index.html"><i class="la la-wrench"></i><span class="menu-title" data-i18n="nav.dash.main">Maintenance</span></a>
        <ul class="menu-content">
      ...
      <li class=" nav-item"><a href="index.html"><i class="la la-search"></i><span class="menu-title" data-i18n="nav.dash.main">Audit</span></a>
        <ul class="menu-content">
